...
if (
     ...
     $desc = $_POST['desc'];
     $unit = $_POST['unit'];
     $sql =  "INSERT INTO `product` (`id`, `name`, `thumb`, `id_cate`, `price`, `sale`, `description`, `created_at`, `updated_at`, `unit`) VALUES (NULL, '$name', '$url', '$idCate', '$price', '$sale', '$desc', '$create_at', NULL, '$unit')";
     execute($sql);
                                   ...
                                   <form id="form_add_product">
                                        <div class="form-row">
                                             <div class="form-group col-md-6">
                                                  ...
                                                  <input type="text" class="form-control" required name="name" id="inputName" placeholder="Product" />
                                             </div>
                                             <div class="form-group col-md-6">
                                        ...
                                        <div class="form-row">
                                             ...
                                             <div class="form-group col-md-6">
                                                  ...
                                                  <input required type="text" name="unit" class="form-control" id="inputUnit" placeholder="Unit" />
                                             </div>
                                        </div>
