...
if (
     ...
     $create_at =
          date("Y/m/d");
     $sql =   "INSERT INTO `user` (`id`, `id_role`, `name`, `password`, `email`, `phone`, `address`, `created_at`, `updated_at`) VALUES (NULL, '$role', '$name', '$hashed_password', '$email', '$phone', '$address', '$create_at', NULL)";
